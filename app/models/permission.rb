...
class Permission < ValueObject
  ...
  RESOURCE_ACTIONS = {
    ...
    DASHBOARD => [
      ...
      DASH_ACTION_NEEDED_NEW_REFERRALS, DASH_ACTION_NEEDED_TRANSFER_AWAITING_ACCEPTANCE, DASH_ACTION_NEEDED_IDENTIFIED,  VIEW_DASHBOARD, VISIT_INTEGRATEDDASHBOARD
    ],
    AUDIT_LOG => [READ],
    USAGE_REPORT => [READ],
